...
-(void)hft_setupTableViewForTableStyle:(UITableViewStyle)style
{
...
-(void)hft_setupGroupedTableView
{
    [self hft_setupTableViewForTableStyle:UITableViewStyleGrouped];
}
-(void)hft_setupPlainTableView
{
    [self hft_setupTableViewForTableStyle:UITableViewStylePlain];
}
