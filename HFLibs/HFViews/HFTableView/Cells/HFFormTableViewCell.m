...
-(void)bindData:(HFFormTableCellObj *)cellObj
{
    ...
    self.titleLabel.textColor = cellObj.titleColor;
   ...
   if(cellObj.accessoryView)
   {
       ...
       if(!CGSizeEqualToSize(cellObj.accessoryViewSize, CGSizeZero))
       {
           [self.titleLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
               ...
               make.right.equalTo(self.contentView).offset(-(cellObj.rigthPadding+10+cellObj.accessoryViewSize.width));
           ...
           [self.titleLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
               ...
               if(cellObj.title)
               {
                   make.right.equalTo(accessoryView.mas_left).offset(-cellObj.leftPadding);
